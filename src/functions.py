...
def function_hw1(input_image, hue, saturation, lightness):
    ...
    output_image_cv2 = input_image
    output_image_cv2 = cv2.cvtColor(output_image_cv2, cv2.COLOR_BGR2HLS)
    ...
    hls_image_cv2 = output_image_cv2
    ...
    hls_image_cv2 = hls_image.astype(np.uint8)
